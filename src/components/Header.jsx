...
export const Header = () => {
  ...
  return (
    <>
      <div className="bg-[#4f3120ff] fixed w-full flex justify-between items-center py-5 px-2 md:py-7 md:px-8">
        <div className="flex-1">
          <a href="#"><img src={logoLight} alt="cozynest" className="w-35 md:w-45"/></a>
        </div>

        <div className="hidden lg:flex lg:justify-center gap-15 font-montserrat font-bold text-[18px] text-white flex-2 tracking-widest uppercase">
          <a href="#home">Home</a>
          <a href="#home">Shop</a>
          <a href="#home">Blog</a>
        ...
        <div className="flex-center gap-5 flex-1 flex justify-end">
          ...
          after:absolute after:rounded-full after:-top-2 after:-right-2">
            <MdOutlineShoppingCart className="text-[#d6c6ad] cursor-pointer text-[30px]"/>
          </div>
